...
(function (global) {
  ...
  var DICT = {
    ...
    de: {
      ...
      "set.keep.hint":     "Ein durchgelaufenes Video bleibt in der Warteschlange, statt gelöscht zu werden. Der Raum bleibt bestehen – über einen Neustart hinweg –, aber nur solange dort mindestens alle 4 Stunden mal wieder jemand vorbeischaut. Bleibt er länger leer, wird er trotzdem gelöscht.",
      ...
      "set.stream.label":  "HLS-Stream",
      "set.stream.hint":   "Zeigt, was gerade im Raum läuft – für einen Fernseher, Chromecast oder OBS, ganz ohne Browser.",
      ...
      "up.dropSub":   "oder klicken zum Auswählen. MP4, WebM, OGG oder MP3, jede Größe.",
      "up.waiting":   "wartet",
      "up.files":     "{n} Dateien",
      ...
      "up.errMobile": "MKV/AVI/MP3 lassen sich auf dem Handy nicht umwandeln. Bitte am Rechner hochladen oder vorher zu MP4 machen.",
      "up.errEmpty":  "Die Datei ist leer.",
    ...
    en: {
      ...
      "set.keep.hint":     "A video that has run through stays in the queue instead of being deleted. The room stays too – across a restart – but only as long as someone drops by at least every 4 hours. Left empty longer than that, it's deleted anyway.",
      ...
      "set.stream.label":  "HLS stream",
      "set.stream.hint":   "Shows whatever the room is currently playing – for a TV, Chromecast or OBS, no browser needed.",
      ...
      "up.dropSub":   "or click to choose. MP4, WebM, OGG or MP3, any size.",
      "up.waiting":   "waiting",
      "up.files":     "{n} files",
      ...
      "up.errMobile": "MKV/AVI/MP3 can't be converted on mobile. Upload from a desktop, or convert to MP4 first.",
      "up.errEmpty":  "The file is empty.",
