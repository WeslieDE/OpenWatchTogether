...
(function (global) {
  ...
  var DICT = {
    ...
    de: {
      ...
      "set.opening.hint":  "Vom Anfang der Datei gemessen, etwa 1:30.",
      "set.ending.label":  "Anfang des Abspanns",
      "set.ending.hint":   "Vom Ende der Datei gemessen, etwa 1:30.",
    ...
    en: {
      ...
      "set.opening.hint":  "Measured from the start of the file, e.g. 1:30.",
      "set.ending.label":  "Start of the ending",
      "set.ending.hint":   "Measured from the end of the file, e.g. 1:30.",
